...
const Registration = () => {
    ...
    const renderStep1 = () => (
        <>
            ...
            <button
                className={classNames(styles.genderButton, {
                    [styles.genderButtonActive]: formData.gender === 'male',
                })}
            ...
            <button
                className={classNames(styles.genderButton, {
                    [styles.genderButtonActive]: formData.gender === 'female',
                })}
    ...
    const renderStep3 = () => (
        <>
            ...
            <div className={styles.buttonGroup}>
                ...
                <button
                    className={styles.nextButton}
                    disabled={!formData.birthDate || error}
                    onClick={handleNext}
                >
                    ДАЛЕЕ
                </button>
    ...
    const renderStep5 = () => (
        <>
            <h2 className={styles.title}>Ваш статус отношений</h2>
            <DropdownSelect
                label="Какая цель вашего знакомства"
            ...
            <div className={styles.mainDiv}>
                <div className={styles.fx}>
                    <h2 className={styles.title}>
                        Какого возраста партнёры вам нравятся?
                    </h2>
